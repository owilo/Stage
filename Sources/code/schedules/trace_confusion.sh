...
#python -m code.analytics.trace_confusion --name "betavae-d" -t 0 --autoencoder "h-betavae128" --classifier "classifier" --tdetector "trace-detector-betavae128-d" --tclassifier "trace-classifier-betavae128"
#python -m code.analytics.trace_confusion --name "betavae-mt-d" -t 2 --autoencoder "h-betavae128" --classifier "classifier" --tdetector "trace-detector-betavae128-mt-d" --tclassifier "trace-classifier-betavae128-mt"