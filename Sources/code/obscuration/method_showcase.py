...
def pgd(eps, file_prefix="0"):
    ...
    save_with_metrics(x_poisoned[0], f"obs_pgd_forward{file_prefix}")
...
blur(sigma=1, file_prefix="0")
blur(sigma=2, file_prefix="1")
blur(sigma=3, file_prefix="2")
blur(sigma=4, file_prefix="3")
blur(sigma=5, file_prefix="4")
blur(sigma=6, file_prefix="5")

selective_encryption(0b00000111, key=b"0123456789abcdef", file_prefix="0")
selective_encryption(0b00111111, key=b"0123456789abcdef", file_prefix="1")
selective_encryption(0b01000000, key=b"0123456789abcdef", file_prefix="2")
selective_encryption(0b10000000, key=b"0123456789abcdef", file_prefix="3")
selective_encryption(0b11000000, key=b"0123456789abcdef", file_prefix="4")
selective_encryption(0b11100000, key=b"0123456789abcdef", file_prefix="5")

bit_flip(block_size=2, key=1, file_prefix="0")
bit_flip(block_size=3, key=1, file_prefix="1")
bit_flip(block_size=4, key=1, file_prefix="2")
bit_flip(block_size=5, key=1, file_prefix="3")
bit_flip(block_size=6, key=1, file_prefix="4")
bit_flip(block_size=7, key=1, file_prefix="5")

fgsm(eps=0.05, file_prefix="0")
fgsm(eps=0.20, file_prefix="1")
fgsm(eps=0.35, file_prefix="2")
fgsm(eps=0.55, file_prefix="3")
fgsm(eps=0.85, file_prefix="4")
fgsm(eps=1.0, file_prefix="5")

pgd(eps=0.08, file_prefix="0")
pgd(eps=0.20, file_prefix="1")
pgd(eps=0.32, file_prefix="2")
pgd(eps=0.44, file_prefix="3")
pgd(eps=0.56, file_prefix="4")
pgd(eps=0.68, file_prefix="5")