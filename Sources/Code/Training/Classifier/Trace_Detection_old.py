...
for src_class in range(10):
    ...
    for dst_class in range(10):
        ...
        Y_classes1 = np.append(Y_classes1, np.full(len(src_classes[dst_class]), int(src_class != dst_class)))
...
model.save("./Models/Classifieur/residual-detection-classifier-128.keras")