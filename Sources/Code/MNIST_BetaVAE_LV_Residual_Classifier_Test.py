...
X_classes_original2 = Utils.encoded(X_classes_original2, "", encoder, decoder, 3, 32, False)
...
X_classes_inverse2 = np.empty((0, 128))
...
for src_class in range(10):
    ...
    for dst_class in range(10):
        ...
        if src_class == dst_class:
            ...
            X_classes_inverse2 = np.concatenate((X_classes_inverse2, X_encoded_src), axis=0)
            continue
        ...
        X_inverse_translated = X_encoded_src - translation

        X_classes_inverse2 = np.concatenate((X_classes_inverse2, X_inverse_translated), axis=0)
...
res_classifier = load_model("./Models/Classifieur/lv-residual-classifier-128.keras")
...
plt.tight_layout()
plt.savefig("./Results/mnist-trace-complete-unchanged-classifier-confusion-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-classifier-confusion-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-classifier-confusion-inverse-dst-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-classifier-confusion-inverse-src-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-classifier-confusion-inverse-predicted-dst-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-classifier-confusion-inverse-predicted-src-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-normal-classifier-confusion-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-normal-classifier-confusion-inverse-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-detection-translation-confusion-lv.png")
...
plt.title(f"Précision : {accuracy:.2%} - Certitude moyenne : {average_certainty:.2%}", fontsize=14)
plt.tight_layout()
plt.savefig("./Results/mnist-trace-detection-translation-confusion-inverse-lv.png")"""
...
#src_class_g, p_g, linp_g = utils.classify(predicted, res_classifier)
...
#axes[0, 1].text(0.5, -0.15, f"({src_class_g}, {p_g.max():.3f})", fontsize=14, color="red", ha="center", transform=axes[0, 1].transAxes)
...
guessed_class_g, p_g, linp_g = Utils.classify(predicted, res_classifier)
...
axes[0, 2].text(0.5, -0.15, f"({guessed_class_g}, {p_g.max():.3f})", fontsize=14, color="red", ha="center", transform=axes[0, 2].transAxes)
...
for dst_class in range(10):
    ...
    guessed_class_g, p_g, linp_g = Utils.classify(translated, res_classifier)
    ...
    axes[0, dst_class + 3].text(0.5, -0.15, f"({guessed_class_g}, {p_g.max():.3f})", fontsize=14, color="red", ha="center", transform=axes[0, dst_class + 3].transAxes)
    ...
    guessed_class_g, p_g, linp_g = Utils.classify(inverse_translated, res_classifier)
    ...
    axes[1, dst_class + 3].text(0.5, -0.15, f"({guessed_class_g}, {p_g.max():.3f})", fontsize=14, color="red", ha="center", transform=axes[1, dst_class + 3].transAxes)
...
plt.tight_layout()
plt.savefig("./Results/mnist-trace-translated-image-lv.png")

# t-SNE
X_encoded = np.concatenate((X_classes2, predicted, translated_encoded, encoded_means.squeeze()))
...
plt.legend()
plt.tight_layout()
plt.savefig(f"./Results/mnist-translation-res-full-tsne-translations-lv.png")
...
plt.legend()
plt.tight_layout()
plt.savefig(f"./Results/mnist-translation-res-full-tsne-lv.png")