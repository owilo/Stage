...
for dst_class in range(10):
    ...
    plt.suptitle(f"Classe translation {dst_class}", fontsize=22)
    ...
    plt.suptitle(f"Différence - Classe translation {dst_class}", fontsize=22)
    plt.xlabel("Classe prédite")
    plt.ylabel("Classe cible")
...
plt.suptitle("Différence - Toutes classes translation", fontsize=22)
plt.xlabel("Classe prédite")
plt.ylabel("Classe cible")
