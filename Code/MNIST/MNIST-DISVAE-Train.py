...
decoder = Model(decoder_input, x, name=f"decoder-{latent_dim}")
z_decoded = decoder(z)
...
encoder = Model(input_img, z_mu, name=f"encoder-{latent_dim}")
encoder.summary()
...
encoder.save(f"./Models/DISVAE/mnist-{latent_dim}-encoder.keras")
decoder.save(f"./Models/DISVAE/mnist-{latent_dim}-decoder.keras")